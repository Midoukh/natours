...
var toursLength = tours ? tours.getAttribute("data-tourslength") : 0; //page = 1: show from 0 to 3
...
var createMenu = function createMenu(state) {
  if (state === "isOpen") {
    ...
    if (checkIfThereIsAuser()) {
      ...
      var userDataInHtml = document.querySelector("#burger-menu span").getAttribute("data-user-obj");
      var userObj = userDataInHtml ? JSON.parse(userDataInHtml) : {};
      var src = userObj.photo ? "/img/users/".concat(userObj.photo) : "/img/users/default.png";
      img.src = src;
...
exports.simplifyString = exports.postData = exports.getData = void 0;
...
var simplifyString = function simplifyString(str) {
  if (str.split(" ").length < 2) return "/".concat(str.toLowerCase());
  return "/".concat(str.toLowerCase().split(" ").join("-"));
};
...
var accountSideNav = document.querySelector(".side-nav"); //Delegation
...
if (form) {
  form.addEventListener("submit", function (e) {
    var oldButtonTextContent = e.target.querySelector("button").textContent; //disable button
...
if (accountSideNav) {
  var userObj = JSON.parse(document.querySelector(".user-view").getAttribute("data-user"));
  Array.from(accountSideNav.children).forEach(function (node) {
    var url = node.children[0].getAttribute("data-api");
    if (url !== "#") node.children[0].addEventListener("click", function () {
      (0, _utils.postData)(url, {
        userId: userObj._id
      });
      if ((0, _utils.simplifyString)(node.children[0].textContent) === url) node.children[0].classList.add("side-nav--active");else node.children[0].classList.remove("side-nav--active");
    });
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40563" + '/');
...
//# sourceMappingURL=public/js/dist.js.map