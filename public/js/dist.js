...
exports.PUB_STRIPE_API_KEY = exports.BASE_API_URL = void 0;
var BASE_API_URL = 'http://localhost:3000/api/v1/';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "".concat(_constants.BASE_API_URL, "bookings/checkout-session/").concat(slug);
            console.log(url);
            _context.next = 4;
            return fetch(url, {
              method: 'GET'
...
},{"./constants.js":"constants.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var bookingBtn = document.getElementById('booking-btn'); //Delegation
